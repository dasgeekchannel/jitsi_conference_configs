...
var config = {
    ...
    hosts: {
        // XMPP domain.
        domain: 'jitsi.destinationlinux.network',

        // When using authentication, domain for guest users.
        anonymousdomain: 'guest.jitsi.destinationlinux.network',

        // Domain for authenticated users. Defaults to <domain>.
        // authdomain: 'jitsi.destinationlinux.network',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.jitsi.destinationlinux.network',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.<!--# echo var="subdomain" default="" -->jitsi.destinationlinux.network'
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: '//jitsi.destinationlinux.network/http-bind',

    // Websocket URL
    // websocket: 'wss://jitsi.destinationlinux.network/xmpp-websocket',

    // The real JID of focus participant - can be overridden here
    // Do not change username - FIXME: Make focus username configurable
    // https://github.com/jitsi/jitsi-meet/issues/7376
    // focusUserJid: 'focus@auth.jitsi.destinationlinux.network',
    ...
    // signalling.
    // webrtcIceUdpDisable: true, //trying this to see if verified packets will create more stable stream without cameras blanking out.Changed from false, to true.
    ...
    //     // by default uses:
    //     // 'https://jitsi.destinationlinux.network/static/oauth.html'
    //     redirectURI:
    //          'https://jitsi.destinationlinux.network/subfolder/static/oauth.html'
    // },
	...
	// enabled these by removing // asnd set disabled true and inactive disabled true
    ...
    // Disables or enables REMB support in this client (default: enabled).
     enableRemb: false, //REMB tries to do congestion control disabling to see if it improves false calculations of connection strength
    ...
    p2p: {
        ...
        stunServers: [
            ...
            // { urls: 'stun:jitsi.destinationlinux.network:3478' },
    ...
    */
    ...
    // moderatedRoomServiceUrl: 'https://moderated.jitsi.destinationlinux.network',
